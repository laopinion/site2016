<div id="menu-superior">
  <div class="menus_content">
    	...
    	<ul class="menu-derecho">
      		...
      		<li class="estado_tiempo"><!--CLIMA--><?php print EjecutarBlockCache('block',21,'largo'); ?><!--FIN CLIMA--></li>
          <li class="picoyplaca"><!--PICO Y PLACA--><?php print EjecutarBlockCache('block',61,'largo'); ?><!--FIN PICO Y PLACA--></li>
