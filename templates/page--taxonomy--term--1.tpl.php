  ...
  <section id="seccion">
    <div id="seccion_content">
      ...
      <div class="izquierda">
        ...
        <!--colombia--><div class="colombia"><h2><a href="<?php print base_path(); ?>colombia">Colombia</a></h2><div class="linea"></div></div><?php $view = views_get_view('secciones_especiales'); print $view->preview('block_2'); ?><!--FIN Ocaña-->
      </div>
      <div class="derecha">
          <div id="sidebar">
