...
<div id="container">
  ...
  <section id="seccion">
    <div id="seccion_content">
      ...
      <!--Indicadores economicos--><div class="indicadores"><?php $block =block_load('block',59); $output = drupal_render(_block_get_renderable_array(_block_render_blocks(array($block)))); print $output; ?></div><!--FIN Indicadores economicos-->
      <div class="izquierda">
      ...
      <div class="derecha">
          ...
          <div id="sidebar_movil">
            <?php include("sidebar_economia.tpl.php"); ?>
          </div> <!-- /#sidebar movil-->
      </div>
      <div class="wide">
