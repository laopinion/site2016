  ...
  <section id="seccion">
    <div id="seccion_content">
      ...
      <div class="izquierda">
        ...
        <!--Cucuta--><div class="cucuta_deportivo"><h2><a href="<?php print base_path(); ?>cucuta-deportivo">Cúcuta deportivo</a></h2><div class="linea"></div></div><?php $view = views_get_view('secciones_especiales'); print $view->preview('block_3'); ?><!--FIN Cucuta-->
        <!--Futbol--><div class="futbol"><h2><a href="<?php print base_path(); ?>futbol">Fútbol</a></h2><div class="linea"></div></div><?php $view = views_get_view('secciones_especiales'); print $view->preview('block_4'); ?><!--FIN Futbol-->
        <!-- + deportes--><div class="mas_deportes"><h2><a href="<?php print base_path(); ?>mas-deportes">+ Deportes</a></h2><div class="linea"></div></div><?php $view = views_get_view('secciones_especiales'); print $view->preview('block_5'); ?><!--FIN + deportes-->
      </div>
      <div class="derecha">
          <div id="sidebar">
      ...
      <div class="wide">
        ...
        <!--Más--><div class="seguir_deportes"><h2>Seguir leyendo</h2><div class="linea"></div></div><?php $view = views_get_view('secciones_generales'); print $view->preview('block_3'); ?><!--FIN Más-->
