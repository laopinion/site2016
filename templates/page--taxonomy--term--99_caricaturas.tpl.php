...
<div id="container">
  ...
  <section id="seccion">
    <div id="seccion_content">
      ...
      <div class="izquierda">
        <!--Ultimas caricaturas--><?php $view = views_get_view('opinion'); print $view->preview('block_6'); ?><!--FIN Ultimas caricaturas-->
        <!--Mas caricaturas--><?php $view = views_get_view('opinion'); print $view->preview('block_7'); ?><!--FIN Mas caricaturas-->
      </div>
      <div class="derecha">
