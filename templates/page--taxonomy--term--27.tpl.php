...
<div id="container">
  ...
  <section id="seccion">
    <div id="seccion_content">
      ...
      <div class="izquierda">
        <!--ultimos audios--><?php $view = views_get_view('multi'); print $view->preview('block_8'); ?><!--FIN Ultimos audios-->
        <!--mas audios--><?php $view = views_get_view('multi'); print $view->preview('block_9'); ?><!--FIN mas audios-->
      </div>
      <div class="derecha">
