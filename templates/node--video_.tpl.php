...
jQuery (function($){
  $(document).ready(function(){
    ...
    var videoplayer = "<iframe id=frame-video width=640 height=370 src=http://www.youtube.com/embed/" + id + "?hl=es&fs=1&rel=0&showinfo=0 frameborder=0 allowfullscreen></iframe>";
