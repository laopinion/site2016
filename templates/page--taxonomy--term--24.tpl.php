...
<div id="container">
  ...
  <section id="seccion">
    <div id="seccion_content">
      ...
      <div class="izquierda">
        <!--ultimos--><?php $view = views_get_view('multi'); print $view->preview('block'); ?><!--FIN Ultimos-->
        <!--fotos--><?php $view = views_get_view('multi'); print $view->preview('block_1'); ?><!--FIN fotos-->
        <!--videos--><?php $view = views_get_view('multi'); print $view->preview('block_2'); ?><!--FIN videos-->
        <!--podcast--><?php $view = views_get_view('multi'); print $view->preview('block_3'); ?><!--FIN podcast-->
      </div>
      <div class="derecha">
