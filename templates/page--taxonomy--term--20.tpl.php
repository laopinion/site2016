...
<div id="container">
  ...
  <section id="seccion">
    <div id="seccion_content">
      ...
      <div class="izquierda">
        <!--Destacada 1--><?php $view = views_get_view('participacion'); print $view->preview('block'); ?><!--FIN Destacada 1-->
        <!--Destacada 2--><?php $view = views_get_view('participacion'); print $view->preview('block_1'); ?><!--FIN Destacada 2-->
        <!--Lista--><?php $view = views_get_view('participacion'); print $view->preview('block_2'); ?><!--FIN Lista-->
        <!--Multimedia--><?php $view = views_get_view('participacion'); print $view->preview('block_3'); ?><!--FIN Multimedia-->
        <!--denuncia--><?php $block = module_invoke('webform', 'block_view', 'client-block-134');print render($block['content']); ?><!--FIN denuncia-->
      </div>
      <div class="derecha">
        <!--Editor a un clic--><!--<?php // $block =block_load('block',5); $output = drupal_render(_block_get_renderable_array(_block_render_blocks(array($block)))); print $output; ?>--><!--FIN Editor a un clic-->
