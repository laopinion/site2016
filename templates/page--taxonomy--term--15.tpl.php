  ...
  <section id="seccion">
    <div id="seccion_content">
      ...
      <div class="izquierda">
        ...
        <!--Tecnologia--><div class="tecnologia"><h2><a href="<?php print base_path(); ?>tecnologia">Tecnología</a></h2><div class="linea"></div></div><?php $view = views_get_view('secciones_especiales'); print $view->preview('block_6'); ?><!--FIN Tecnologia-->
        <!--Cultura--><div class="cultura"><h2><a href="<?php print base_path(); ?>cultura">Cultura</a></h2><div class="linea"></div></div><?php $view = views_get_view('secciones_especiales'); print $view->preview('block_7'); ?><!--FIN Cultura-->
        <!--Tendencias--><div class="tendencias"><h2><a href="<?php print base_path(); ?>tendencias">Tendencias</a></h2><div class="linea"></div></div><?php $view = views_get_view('secciones_especiales'); print $view->preview('block_8'); ?><!--FIN Tendencias-->
      </div>
      <div class="derecha">
          <div id="sidebar">
      ...
      <div class="wide">
        ...
        <!--Más--><div class="seguir_entretenimiento"><h2>Seguir leyendo</h2><div class="linea"></div></div><?php $view = views_get_view('secciones_generales'); print $view->preview('block_3'); ?><!--FIN Más-->
