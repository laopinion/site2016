  ...
  $(".view-id-principal.view-display-id-block_9 .views-row").each(function(){
    ...
    if(principal == 0){
      if(plataforma == "YouTube"){ 
        ...
        var twitterplayer = "<div class=twitterplayer> <iframe class=iframetwitter frameborder=0 width=680 height=450px src=https://twitter.com/i/videos/tweet/" + idtwitter + "></iframe></div>";
    ...
    if(plataforma == "YouTube"){ 
      ...
      contador++;
      var idtwitter = $(this).find(".id").html();
      var twitterplayer = "<div class=twitterplayer> <iframe class=iframetwitter frameborder=0 margin-top: 20px margin-left: 15px  width=680 height=450px src=https://twitter.com/i/videos/tweet/" + idtwitter + "></iframe></div>";
...
//Script player videos-->
  ...
  var twitterplayer = "<iframe src=https://twitter.com/i/videos/tweet/"+ id + " width=1006 height=610 frameborder=0></iframe>";
