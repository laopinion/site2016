...
<div id="container">
  ...
  <section id="seccion">
    <div id="seccion_content">
      ...
      <div class="izquierda">
        <!--ultimas fotos--><?php $view = views_get_view('multi'); print $view->preview('block_4'); ?><!--FIN Ultimas fotos-->
        <!--mas fotos--><?php $view = views_get_view('multi'); print $view->preview('block_5'); ?><!--FIN mas fotos-->
      </div>
      <div class="derecha">
