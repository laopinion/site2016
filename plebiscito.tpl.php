<section id="plebiscito">
		...
		<div class="nacional">			
		    ...
		    <div class="nulosysufraga">
			    <div class="nulos">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $nulosv; ?>
					</div>
			    </div>
			    <div class="sufragantes">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $sufragantesv; ?>
					</div>
			    </div>		
		    </div>
	</div>
	...
	<div class="der">
		<h3>Municipios mas importantes del Norte de Santander</h3>
		<section class="colum1">
			<div class="cucuta">
				...
				<div class="cucutapsi">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $cucutavsi; ?>
					</div>
			    </div>
				<h2 class="no">NO</h2>
			    <div class="cucutapno">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $cucutavno; ?>
					</div>
			    </div>
			</div>
			...
			<div class="rosario">
				...
				<div class="rosariopsi">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $rosariovsi; ?>
					</div>
			    </div>
				<h2 class="no">NO</h2>
			    <div class="rosariopno">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $rosariovno; ?>
					</div>
			    </div>
			</div>
			...
			<div class="pamplona">
				...
				<div class="pamplonapsi">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $pamplonavsi; ?>
					</div>
			    </div>
				<h2 class="no">NO</h2>
			    <div class="pamplonapno">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $pamplonavno; ?>
					</div>
			    </div>
			</div>
		</section>
		...
		<section class="colum2">
			<div class="patios">
				...
				<div class="patiospsi">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $patiosvsi; ?>
					</div>
			    </div>
				<h2 class="no">NO</h2>
			    <div class="patiospno">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $patiosvno; ?>
					</div>
			    </div>
			</div>
			...
			<div class="ocana">
				...
				<div class="ocanapsi">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $ocanavsi; ?>
					</div>
			    </div>
				<h2 class="no">NO</h2>
			    <div class="ocanapno">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $ocanavno; ?>
					</div>
			    </div>
			</div>
			...
			<div class="norte">
				...
				<div class="nortepsi">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $nortevsi; ?>
					</div>
			    </div>
				<h2 class="no">NO</h2>
			    <div class="nortepno">
					...
					<div class="valor">	
			      		<span>Numero de votos: </span><?php print $nortevno; ?>
					</div>
			    </div>
			</div>
		</section>
