    ...
    <div class="izq">
      <!--ANUNCIO 1000x90--><div class="pauta p1000x90" style="display: none"><?php include("pautas/S_1000x90.php"); ?></div><!--FIN ANUNCIO 1000x90-->
        ...
        <div class="der">
          ...
          <?php print EjecutarViewCache('recientes','block','corto'); ?><!--FIN Noticias Recientes-->
          ...
          <!--Noticias Recientes-->
          <!--Noticias Recientes--><?php print EjecutarViewCache('recientes','block_1','corto'); ?><!--FIN Noticias Recientes-->   
