...
<div id="columna_opinion">
  ...
  <div class="izq">
    ...
    <!--ANUNCIO 300x250--><div class="pauta p300x250"><h2 class="anuncio_txt">Publicidad</h2><div class="info"><?php include("pautas/dfp/embimedia_1.php"); ?></div></div><!--FIN ANUNCIO 300x250-->
  ...
  <div class="notas_footer">
    <!--Noticias Recientes--><?php print EjecutarViewCacheArg('recientes','block_3','q','mediano'); ?><!--FIN Noticias Recientes-->
