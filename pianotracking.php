...
tp = window["tp"] || [];
tp.push(["setAid", "yZbvvMnWiT"]);
tp.push(["setContentSection", data.contentSection]);
tp.push(["setContentAuthor", data.contentAuthor]);
tp.push(["setContentCreated", data.contentCreated]);
tp.push(["setTrackPages", false]);
tp.push(["init", function() {
tp.main.pageTrack({ 
url: window.location.href, 
tags: "news, piano, cucuta, colombia, la opinion, norte de santander" // You can also use array object here 
}); 
}]); 
(function(src){var a=document.createElement("script");a.type = "text/javascript";a.async=true;a.src=src;var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a, b)})("//cdn.tinypass.com/api/tinypass.min.js");
</script> 
