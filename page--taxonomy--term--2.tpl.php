<section id="cucuta">
      <div class="content">
        ...
        <div class="der movil">
          ...
          <!--ANUNCIO 300x250--><div class="pauta desktop p300x250" style="float:left"><h2 class="anuncio_txt">Publicidad</h2><div class="info"><?php $block =block_load('block',49); $output = drupal_render(_block_get_renderable_array(_block_render_blocks(array($block)))); print $output; ?></div></div><!--FIN ANUNCIO 300x250-->
        </div>
        <div class="mid">           
          <!--Por los barrios--><?php $view = views_get_view('s_general_sub'); print $view->preview('block_2'); ?><!--FIN Por los barrios-->
        </div>
        <!--ANUNCIO 728x90--><div class="pauta desktop p728x90" style="margin:0px 135px 15px 135px"><h2 class="anuncio_txt">Publicidad</h2><div class="info"><?php $block =block_load('block',49); $output = drupal_render(_block_get_renderable_array(_block_render_blocks(array($block)))); print $output; ?></div></div><!--FIN ANUNCIO 728x90-->
        <div class="mid">           
        ...
        <div class="mid"><!--Seguir leyendo-->         
          ...
          <!--ANUNCIO 300x250--><div class="pauta desktop pauta_lateral p300x250" style="margin-top: 35px;float:left"><h2 class="anuncio_txt">Publicidad</h2><div class="info"><?php $block =block_load('block',49); $output = drupal_render(_block_get_renderable_array(_block_render_blocks(array($block)))); print $output; ?></div></div><!--FIN ANUNCIO 300x250-->
